...
class EditDataQualityPB extends StatefulWidget {
  final List list;
  final int index;
  ...
  @override
  State<EditDataQualityPB> createState() => _EditDataQualityPBState();
}

class _EditDataQualityPBState extends State<EditDataQualityPB> {
  ...
  void EditDataQualityPBFunc() {
    var url = Uri.parse("http://172.16.29.11:46/wb_quality/pb_editdata.php");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Edit Data Quality PB"),
