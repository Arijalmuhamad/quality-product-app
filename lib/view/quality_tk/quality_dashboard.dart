...
class QualityDashboardTK extends StatefulWidget {
  const QualityDashboardTK({super.key});

  @override
  State<QualityDashboardTK> createState() => _QualityDashboardTKState();
}

class _QualityDashboardTKState extends State<QualityDashboardTK> {
  ...
  Future<List> getData() async {
    ...
    var url = Uri.parse(
      "${baseUrl}tk_getdataDashboard.php",
    );
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder:
                        // Pastikan datauser[0]['name'] valid
                        (BuildContext context) => HomeWB(datauser[0]['name']),
                  ),
                );
              },
              style: ButtonStyle(
            ...
            ElevatedButton(
              onPressed: () {
                // Refresh halaman dengan me-replace dirinya sendiri
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (BuildContext context) =>
                        const QualityDashboardTK(),
                  ),
                );
              },
              style: ButtonStyle(
            ...
            MaterialPageRoute(
              builder:
                  ...
                  (BuildContext context) =>
                      AddDataQualityTK(datauser[0]['name']),
            ),
          ),
        ...
        return Container(
            ...
            child: GestureDetector(
              onTap: () => Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (BuildContext context) =>
                      DetailQualityTK(list: list, index: i),
                ),
              ),
              child: Card(
                child: ListTile(
