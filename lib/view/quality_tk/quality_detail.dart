...
class DetailQualityTK extends StatefulWidget {
  // Menggunakan final dan super.key agar konsisten dengan gaya PL
  final List list;
  final int index;
  const DetailQualityTK({super.key, required this.index, required this.list});

  @override
  State<DetailQualityTK> createState() => _DetailQualityTKState();
}

class _DetailQualityTKState extends State<DetailQualityTK> {
  // =====================================================================
  ...
  void deleteDataQualityFunc() async {
    ...
    var url = Uri.parse("${baseUrl}tk_deletedata.php");
